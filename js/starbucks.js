$(document).ready(function(){
    ...
    $('.tab_title ul li').click(function(e){
        ...
        // 모든 내용 숨김
        $('.tab_con>div').hide();
        // 클릭한 제목(li)과 같은 인텍스번호를 가진 내용만 보임
    ...
    // 패밀리 사이트 제목에서 마우스 아웃하면 family_list 내려감
    ...
    $(window).scroll(function(){
        ...
        // 만약 .s2영역이 보이면, && ('그리고'라는 뜻의 논리 연산자)조건 2개 모두 true일때 실행
        ...
        // 만약 .s3영역이 보이면, && ('그리고'라는 뜻의 논리 연산자)조건 2개 모두 true일때 실행
        ...
        // 만약 .s4영역이 보이면, && ('그리고'라는 뜻의 논리 연산자)조건 2개 모두 true일때 실행
        ...
        // 만약 .s5영역이 보이면, && ('그리고'라는 뜻의 논리 연산자)조건 2개 모두 true일때 실행
        if( scroll4 < winTop){
